...
public class DeviceManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (!TreasureChest.openingChest && TreasureChest.openingChest && playerController != null && playerController.Grounded && playerController.isDodge == false && _input.aiming == false && WeaponChanger.isDeactived)
            {
                ToggleUI();
            }
        }
