...
public class InteractUIManger : MonoBehaviour
{
    ...
    public enum TextType { Open, Close, Close2, Ingredient, UnlockRecipe, Sleep, FailMenu, ClearMenu }
    ...
    public void UsingText(TextType textType)
    {
        ...
        else
        {
            ...
            if (textType == TextType.Open || textType == TextType.Close || textType == TextType.ClearMenu)
            {
